...
namespace Vexillum.ui
{
    ...
    public class CustomInputControlRenderer :
      IFlatControlRenderer<CustomInputControl>,
      Nuclex.UserInterface.Controls.Desktop.IOpeningLocator
    {
        ...
        /// </param>
        public void Render(
          CustomInputControl control, IFlatGuiGraphics graphics
        )
        {
            ...
            using (graphics.SetClipRegion(controlBounds))
            {
                ...
                if (control.HasFocus)
                {
                    ...
                    {
                        graphics.DrawCaret(
                          "input.normal", controlBounds, text, control.CaretPosition
                        );
                    }
                }
            }
